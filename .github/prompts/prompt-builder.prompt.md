...
Your task is to create a new `generate-backup-feature.prompt.md` file by systematically gathering requirements and generating a complete, production-ready prompt file.

### 1. **Prompt Identity & Purpose**

- What is the intended filename for your prompt (e.g., `generate-backup-feature.prompt.md`)?
- Provide a clear, one-sentence description of what this prompt accomplishesa
